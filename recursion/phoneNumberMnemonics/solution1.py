...
If you open the keypad of your mobile phone, it'll likely look like this:
  ...
  number 8464747328 can be written as timisgreat; similarly, the phone number 2686463 can be written as
...
def phoneNumberMnemonicsHelper(idx, phoneNumber, currentMnemonic,
                               mnemonicFound):
